...
class HtmlAttribute
{
    ...
    const AUTOFOCUS = [
        'name' => 'autofocus',
        'for' => [
            Tag::BUTTON, Tag::INPUT, Tag::KEYGEN,
    ...
    const CITE = ['name' => 'cite', 'for' => [
        Tag::BLOCKQUOTE, Tag::DEL, Tag::INS, Tag::Q
    ]];
    ...
    const DISABLED = ['name' => 'disabled', 'for' => [
        Tag::BUTTON, Tag::FIELDSET, Tag::INPUT,
        Tag::KEYGEN, Tag::OPTGROUP, Tag::OPTION,
        Tag::SELECT, Tag::TEXTAREA
    ]];
    ...
    const FORM = ['name' => 'form', 'for' => [
        Tag::BUTTON, Tag::FIELDSET, Tag::INPUT, Tag::KEYGEN,
        Tag::LABEL, Tag::METER, Tag::OBJECT, Tag::OUTPUT,
        Tag::SELECT, Tag::TEXTAREA
    ]];
